...
/**
 * This is class plugin_gotop_admin
 * 
 ...
 * @since 1.0.0
 */
class plugin_gotop_admin extends e_admin_dispatcher
{
    /**
    ...
    protected $modes = array('main' => array(
            'controller' => 'plugin_gotop_admin_ui',
            'path' => null,
            'ui' => 'plugin_gotop_admin_form_ui',
            'uipath' => null));
...
/**
 * This is class plugin_gotop_admin_ui
 *
 */
class plugin_gotop_admin_ui extends e_admin_ui
{
    /**
     * $pluginTitle
     *
    ...
    /**
     * plugin_gotop_admin_ui::setPrefs()
     * 
    ...
    private function setPrefs()
    {
        ...
        $this->prefs = array(
            ...
            'gotop_Admin' => array(
                ...
                'tab' => 0),
            'gotop_icon' => array(
                'title' => LAN_PLUGIN__GOTOP_ADMIN_ICON,
                'help' => LAN_PLUGIN__GOTOP_ADMIN_ICON_HELP,
                'type' => 'dropdown',
                'data' => 'str',
                'tab' => 0,
                'validate' => false,
            ...
            'gotop_HOffset' => array(
                ...
                'writeParms' => array('max' => 50, 'min' => 10)),
            ...
            'gotop_iconColour' => array(
                ...
                'writeParms' => array('optArray' => $colourCodes, 'class' => 'colorpicker')),
...
new plugin_gotop_admin();

/*
* Uncomment the below only if you disable the auto observing above
* Example: $dispatcher = new plugin_gotop_admin(null, null, false);
*/
...
function e_help()
{
 ...
 //   $helpArray = e_version::genUpdate('gotop');
  //  return $helpArray;
}
